...
const InsuranceDialog: React.FC<InsuranceDialogProps> = ({ onConfirmYes }) => {
    ...
    return (
        <Box bottom={16} right={16}>
            ...
            >
                <DialogTitle sx={{ color: 'brown', textAlign: 'center' }}>Select an Insurance Type</DialogTitle>
            ...
            <Dialog open={showConfirmDialog} onClose={() => setShowConfirmDialog(false)}>
                <DialogTitle sx={{ color: 'brown' }}>
                    Would you like to explore more about insurance?
                </DialogTitle>
                <DialogActions>
