...
const InvestmentDialog: React.FC<InvestmentDialogProps> = ({ onConfirmYes }) => {
    ...
    // Commenting out the Speech Recognition functionality
                ...
                <DialogContent sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', p: 2 }}>
                    ...
                    >
                        ...
                        <Box sx={{ display: 'flex', gap: 1, ml: 1 }}>
                            ...
                            {/* Commenting out Speech Recognition functionality */}
                            {/* <IconButton
                                onMouseDown={() => {
                                    if (recognition) {
                                        try {
...
Edit
        ...
        <Dialog open={showConfirmDialog} onClose={() => setShowConfirmDialog(false)}>
            <DialogTitle>Do you want to proceed with this investment?</DialogTitle>
            <DialogActions>
                <Button onClick={() => handleUserResponse(false)} color="secondary">
                    No
                </Button>
                <Button onClick={() => handleUserResponse(true)} color="primary">
                    Yes
                </Button>
            </DialogActions>
        </Dialog>
