            ...
            <Grid container direction="row"
                ...
                }
                {
                    stepsUpdate.nomineeDetails === 30 ?
                        <Grid item>
                            <Tooltip title={stepsUpdate.nomineeDetails === 30 ? "Personal Details" : "personal Details"}>
                                <IconButton sx={{ p: 0.2 }}>
                                    <CompleteStepIcon sx={{ fontSize: 15, color: "green" }} />
                                </IconButton>
                            </Tooltip>
                        ...
                        (stepsUpdate.nomineeDetails === 20 ?
                            <Grid item>
                                <Tooltip title={stepsUpdate.nomineeDetails === 20 ? "Personal Details" : "personal Details"}>
                                    <IconButton sx={{ p: 0.2 }}>
                                        <InProgressStepIcon sx={{ fontSize: 15, color: "green" }} />
                                    </IconButton>
                                </Tooltip>
                            ...
                            <Grid item>
                                <Tooltip title={stepsUpdate.nomineeDetails === 10 ? "Personal Details" : "personal Details"}>
                                    <IconButton sx={{ p: 0.2 }}>
                                        <InCompleteStepIcon sx={{ fontSize: 15, color: "green" }} />
                                    </IconButton>
                                </Tooltip>
