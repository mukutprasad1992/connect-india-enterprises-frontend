...
const LifeInsuranceFormDialog: React.FC<Props> = ({
  ...
  >({});
  const [
    openLifeInsuranceSuccessSnackbar,
    setOpenLifeInsuranceSuccessSnackbar,
  ] = useState(false);
  ...
  const handleSelectChange = (event: SelectChangeEvent<string>) => {
    ...
    setFormData((prev) => ({
      ...
      itrDocumentsFileKey:
        value === "Business" ? prev.itrDocumentsFileKey : null,
    }));
  };
  ...
  const validateStep = useCallback(() => {
    ...
    switch (step) {
      case 1:
        (["aadharNumber", "panNumber"] as (keyof LifeInsuranceData)[]).forEach(
          (field) => {
      ...
      case 2:
        (
          [
            ...
            "smoker",
            "alcohol",
          ] as (keyof LifeInsuranceData)[]
        ).forEach((field) => {
          const error = validateField(
            field,
            formData[field as keyof LifeInsuranceData] as string | File | null,
          );
          if (error) {
            newErrors[field] = error;
            isValid = false;
      ...
      case 3:
        ...
        break;
      case 4:
        const documentFields: (keyof LifeInsuranceData)[] = [
          "aadharCardFileKey",
          "panCardFileKey",
          "bankProofFileKey",
        ];
          ...
          <Grid container spacing={3}>
            ...
            <Grid item {...gridSpacing}>
              <TextField
                ...
                value={
                  formData.nomineeDOB
                    ? formatDateForInput(formData.nomineeDOB)
                    : ""
                }
                onChange={handleInputChange}
                onBlur={handleBlur}
